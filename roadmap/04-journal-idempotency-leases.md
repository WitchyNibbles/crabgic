...
- [ ] `$XDG_STATE_HOME`/`$XDG_CACHE_HOME` crabgic roots are defined exactly once in this package — evidence: repo-wide lint/grep CI check fails if another package reimplements the root instead of importing it.
