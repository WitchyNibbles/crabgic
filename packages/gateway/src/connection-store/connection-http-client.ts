...
export async function resolveCustomCaPem(connection: ExternalConnection): Promise<string | undefined> {
...
export function buildAllowlistForConnection(connection: ExternalConnection): GatewayHttpClientOptions["allowlist"] {
