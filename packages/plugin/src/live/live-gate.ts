 ...
 * a re-implementation of `@crabgic/engine-claude`'s much larger live harness
 ...
 * gate only needs to reproduce the `CRABGIC_LIVE` fail-red convention itself.
 */
export class LiveEnvNotEnabledError extends Error {
  constructor() {
    super(
      "CRABGIC_LIVE is not set to '1' — this @live plugin-load smoke test refuses to run and MUST " +
